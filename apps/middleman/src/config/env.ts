...
export const env = cleanEnv(process.env, {
    ...
    OWNER_IDENTITY: poktAddress({
        desc: 'The user identity of the owner of the middleman app. Must be a valid POKT bech32 address (e.g., pokt1abc123...).',
    }),
    APP_IDENTITY: str({
        desc: 'The governance identity of the middleman app. This is expected to be a hex-encoded private key.',
    })
});
